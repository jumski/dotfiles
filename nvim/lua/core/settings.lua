...
opt.tabstop = 2
-- "================ TABS AND SPACES
opt.expandtab = true -- all tabs expands to spaces
opt.shiftwidth = 2 -- automagic indent width
opt.tabstop = 2 -- size of tab in spaces
opt.shiftround = true -- round indent to multiple of 'shiftwidth', applies to > and <
opt.smarttab = true -- use shiftwidth for <Tab> and <BS>
