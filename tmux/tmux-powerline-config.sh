...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="jumski"
	# Overlay directory to look for themes. There you can put your own themes outside the repo. Fallback will still be the "themes" directory in the repo.
	export TMUX_POWERLINE_DIR_USER_THEMES="${DOTFILES_PATH}/tmux/tmux-powerline-themes"
	...
	export TMUX_POWERLINE_STATUS_RIGHT_LENGTH="20"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/jumski/.mail/inbox/new"

	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/jumski"

	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/jumski/.mailcheckrc"
# }
